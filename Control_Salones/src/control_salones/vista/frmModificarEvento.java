 ...
 * @author efi
 */
public class frmModificarEvento extends javax.swing.JFrame {
...
//catalogoEvento.setEstado_modulo(Integer.parseInt(txtEstadoModulo.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmModificarEvento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmModificarEvento().setVisible(true);
            }
        });
    }
